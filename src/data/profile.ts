...
export const profile: Profile = {
      ...
      projects: [
        ...
        },
        {
          ...
          details: [
            ...
            'Pulumi、Firestore、Cloud Run、GCS等を用いたインフラ構築から、設計、実装、テスト、リリース、運用改善まで一貫して担当',
      ...
      projects: [
        {
          ...
          details: [
            ...
            'ONNX Runtimeを用いて特徴量抽出処理を高速化し、PyTorch、CUDAを含む実行環境の互換性を調整しながら安定運用を実現',
  ...
  servicePages: {
    aiDevelopment: {
      ...
      cases: [
        {
          title: 'デプロイ頻度が1日平均0.2回から1.2回へ',
          paragraphs: [
            'Claude Code等を導入しても開発効率が変わらない自社プロダクト開発チームに参画。ドメイン知識、仕様、設計方針、実装規約、レビュー観点をAIが参照できる形に整え、利用ルールと開発フローへ組み込みました。',
            'デプロイ頻度の1日平均は、参画前の0.2回から環境構築後には1.2回へ徐々に上昇しました。',
          ],
        },
        {
          title: '暗黙知を整理し、チームで使える開発基盤へ',
          paragraphs: [
    ...
    productDevelopment: {
      ...
      cases: [
        {
          title: 'MVP立ち上げから、他部署プロダクトへの移管・展開',
          paragraphs: [
        ...
        {
          title: '広告設定改善支援サービスへのAI導入・評価基盤構築',
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'インターネット広告実績統合BIサービスでは集計バッチを約1時間から約30分へ短縮。レコメンドウィジェット配信サービスでは1日2億件以上の広告配信ログを扱う集計基盤を改善し、月額約150万円のインフラコストを削減しました。',
          ],
        },
      ],
    ...
    businessImprovement: {
      ...
      availability: '週1日程度を目安に支援します。支援内容・稼働日数・開始時期はご相談ください。',
      challenges: [
  ...
  projects: [
    {
      title: 'AI開発生産性向上',
      description:
        '複数プロダクトで開発コンテキスト、ルール、開発フローを整備。自社プロダクト開発チームではデプロイ頻度の1日平均が0.2回から1.2回へ向上。横断支援先のメンバーへのアンケートでは、体感の生産性が平均60%以上向上したという回答を確認。',
