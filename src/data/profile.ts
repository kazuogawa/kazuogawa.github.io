      ...
      projects: [
        {
          ...
          details: [
            ...
            '自社プロダクト開発チームでは、参画前と環境構築後を週あたりで比較し、人数が変わらない条件で、デプロイ頻度が週1回から1日1回以上へ向上',
    ...
    highlights: [
      {
        ...
        description:
          '開発コンテキストと運用ルールを整備。自社プロダクト開発チームでは、人数不変で週1回から1日1回以上のデプロイへ。複数プロダクトへのGoogleフォームでは、体感の生産性が平均60%以上向上したという自己評価を確認しました。',
      },
      {
        title: 'アカウントカルテ',
        description:
    ...
    offerings: [
      {
        ...
        evidence: [
          '自社プロダクト開発チームでは、人数が変わらない条件で、週あたりのデプロイ頻度が週1回から1日1回以上へ向上',
          '横断支援した複数プロダクトのメンバーへのGoogleフォームでは、体感の生産性が平均60%以上向上したという自己評価を確認',
        ],
      },
      {
  ...
  projects: [
    {
      title: 'AI開発生産性向上',
      description:
        '複数プロダクトで開発コンテキスト、ルール、開発フローを整備。自社プロダクト開発チームでは人数不変でデプロイ頻度が週1回から1日1回以上へ向上。横断支援先へのGoogleフォームでは、体感の生産性が平均60%以上向上したという自己評価を確認。',
