    ...
    highlights: [
      {
        ...
        description:
          '開発コンテキストと運用ルールを整備。自社プロダクト開発チームでは、デプロイ頻度の1日平均が0.2回から1.2回へ向上。複数プロダクトへのGoogleフォームでは、体感の生産性が平均60%以上向上したという自己評価を確認しました。',
      },
      {
        title: 'アカウントカルテ',
        description:
  ...
  projects: [
    {
      title: 'AI開発生産性向上',
      description:
        '複数プロダクトで開発コンテキスト、ルール、開発フローを整備。自社プロダクト開発チームではデプロイ頻度の1日平均が0.2回から1.2回へ向上。横断支援先へのGoogleフォームでは、体感の生産性が平均60%以上向上したという自己評価を確認。',
