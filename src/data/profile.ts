      ...
      projects: [
        {
          ...
          details: [
            ...
            '自社プロダクト開発チームでは、Findy Teamで確認したデプロイ頻度の1日平均が0.2回から1.2回へ向上。比較期間中のチーム人数は不変',
      ...
      cases: [
        {
          ...
          paragraphs: [
            ...
            'Findy Teamで確認したデプロイ頻度の1日平均は、参画前の0.2回から環境構築後には1.2回へ徐々に上昇しました。チーム人数は比較期間中に変わっていません。',
          ],
          trend: {
            title: 'デプロイ頻度の推移',
            ariaLabel: 'デプロイ頻度が1日平均0.2回から1.2回へ上昇した推移',
            beforeLabel: '参画前',
            beforeValue: '0.2回',
            afterLabel: '環境構築後',
            afterValue: '1.2回',
            unit: 'デプロイ頻度（1日平均）',
            xAxisLabel: '週（経過）',
            note: 'Findy Teamで確認した実測値。始点と終点を表示し、中間の曲線は徐々に上昇した推移傾向を示しています。',
          },
        },
        {
    ...
    highlights: [
      {
        ...
        description:
          '開発コンテキストと運用ルールを整備。自社プロダクト開発チームでは、人数不変でデプロイ頻度の1日平均が0.2回から1.2回へ向上。複数プロダクトへのGoogleフォームでは、体感の生産性が平均60%以上向上したという自己評価を確認しました。',
      },
      {
        title: 'アカウントカルテ',
        description:
    ...
    offerings: [
      {
        ...
        evidence: [
          '自社プロダクト開発チームでは、人数が変わらない条件で、デプロイ頻度の1日平均が0.2回から1.2回へ向上',
          '横断支援した複数プロダクトのメンバーへのGoogleフォームでは、体感の生産性が平均60%以上向上したという自己評価を確認',
        ],
      },
      {
  ...
  projects: [
    {
      title: 'AI開発生産性向上',
      description:
        '複数プロダクトで開発コンテキスト、ルール、開発フローを整備。自社プロダクト開発チームでは人数不変でデプロイ頻度の1日平均が0.2回から1.2回へ向上。横断支援先へのGoogleフォームでは、体感の生産性が平均60%以上向上したという自己評価を確認。',
