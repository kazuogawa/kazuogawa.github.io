    ...
    >
      <nav className="relative mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
        ...
        <button
          ...
          className="flex h-11 w-11 items-center justify-center text-slate-700 transition-colors hover:text-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 md:hidden dark:text-slate-200 dark:hover:text-brand-400 dark:focus:ring-offset-slate-900"
        >
            ...
            {navItems.map((item) => (
              <li key={item.href}>
                <a
                  ...
                  className="block py-3 text-base font-medium text-slate-700 transition-colors hover:text-brand-600 focus:text-brand-600 focus:outline-none dark:text-slate-200 dark:hover:text-brand-400 dark:focus:text-brand-400"
                >
                  {item.label}
                </a>
              </li>
